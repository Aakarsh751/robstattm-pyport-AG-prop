...
Complete test code, pure-Python implementations, and full numerical
results for all validated functions are provided in the companion
test document:
\href{https://github.com/Aakarsh751/robstattm-pyport-AG-prop/blob/main/docs/gsoc2026_proposal/robstatpy_tests.pdf}{	exttt{robstatpy\_tests.pdf}}.
All 15/15 subprocess checks and 14/14 rpy2 checks pass;
the two reproducible notebooks are available in
\href{https://github.com/Aakarsh751/robstattm-pyport-AG-prop/blob/main/robstattm/python/}{	exttt{robstattm/python/}} in the project repository.
